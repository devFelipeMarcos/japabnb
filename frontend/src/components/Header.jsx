...
const Header = (props) => {
  return (
    <header className="shadow-md">
      {/* LOGO */}
      <div className="shado mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-8">
        <Link to="/" className="flex items-center">
          <img
            className="h-10"
            src="../../assets/imgs/japa.png"
            alt="Logo do Japa"
          />
          <p className="text-primary-400 text-2xl font-bold">Japabnb</p>
        </Link>
